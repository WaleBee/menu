                ...
                <div class="modal-body">
                    ...
                    <div class="basic-form">
                            ...
                            <div class="form-group">
                                <input type="text" name="category" class="form-control input-default " placeholder="Sub Category Name">
                            </div>
    ...
    <div class="modal fade" id="basicModal1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{url('/update_subcategory')}}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="modal-body">
                    <div class="avatar-upload">
                    ...
                    <div class="form-group">
                        <label>Main Category</label>
                        <select class="form-control edit-select" name="main" id="sel1">
                            <option value="">Select</option>
                            @foreach ($main as $mains)
                            <option value="{{$mains->name}}">{{$mains->name}}</option>
                            @endforeach
...
<script src="vendor/sweetalert2/dist/sweetalert2.min.js"></script>
    <script>
        $('.delete').on('click', function(){
            var id = $(this).data('id');
            $('.category-delete').attr('href', "{{url('/subcategory_delete')}}" + '/' + id);
        });
    </script>
    @if(session('delete'))
    <script>
